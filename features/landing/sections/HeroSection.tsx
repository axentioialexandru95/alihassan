  ...
  return (
    ...
    >
      ...
      >
        ...
        <a
          className="absolute bottom-7 left-7 z-20 max-w-[23.2rem] text-[15px] leading-[1.6] font-medium text-brand-soft no-underline sm:bottom-[18%] sm:left-[5%] sm:text-base lg:bottom-auto lg:left-[69px] lg:top-[67.6%]"
          data-node-id="11:80"
          href="#services"
        >
        ...
        >
          <span
            className="inline-flex h-16 items-center justify-center gap-[8.872px] rounded-[60px] bg-brand-pink px-[21.292px] text-[14.195px] font-semibold"
            data-node-id="11:82"
          >
          ...
          <span
            className="inline-flex h-[64.585px] w-[64.585px] items-center justify-center rounded-[47.361px] bg-brand-pink p-[18.216px]"
            data-node-id="11:97"
          >
        ...
        <a
          className="absolute right-5 bottom-7 z-20 inline-flex items-center gap-2.5 rounded-full bg-brand-pink px-5 py-3 text-sm font-semibold text-brand-navy no-underline sm:right-7 lg:hidden"
          href="#contact"
        >
          <CalendarLoveIcon className="h-5 w-5" />
          <span>Book Appointment</span>
          <span className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-brand-pink">
