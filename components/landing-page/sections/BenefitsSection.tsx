	...
	return (
		<section className="px-3 pb-4 md:px-4 md:pb-5">
			<div className="rounded-[32px] bg-brand-soft px-5 py-8 sm:px-7 sm:py-10">
				<h2 className="mx-auto max-w-[16ch] text-center font-(family-name:--font-brand) text-[2.15rem] leading-[1.08] font-semibold tracking-[-0.06em] text-brand-navy sm:text-[3rem]">
