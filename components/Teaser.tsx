		...
		>
			...
			<div className="relative">
				...
				<div className="mt-8 flex flex-col gap-3 sm:flex-row">
					<a
						className="inline-flex h-12 items-center justify-center rounded-full bg-brand-blue px-6 text-sm font-medium text-white no-underline shadow-[0_14px_28px_rgba(0,112,250,0.25)] transition duration-[180ms] ease-out hover:-translate-y-px hover:shadow-[0_18px_32px_rgba(0,112,250,0.28)]"
						href="#contact"
					>
						Book a consultation
					</a>
					<a
						className="inline-flex h-12 items-center justify-center rounded-full border border-[rgba(22,33,91,0.12)] bg-white/70 px-6 text-sm font-medium text-brand-navy no-underline transition duration-[180ms] ease-out hover:border-[rgba(0,112,250,0.25)] hover:text-brand-blue"
						href="#services"
					>
						Explore services
					</a>
